...
class mainframe ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Cloud Sensor Monitoring", pos = wx.DefaultPosition, size = wx.Size( 750,420 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )

		self.SetSizeHints( wx.DefaultSize, wx.Size( 800,450 ) )
		self.SetFont( wx.Font( 8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Arial" ) )

		bSizer1 = wx.BoxSizer( wx.VERTICAL )

		self.m_panel6 = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.m_panel6.SetFont( wx.Font( 8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Arial" ) )
		...
		sbSizer5 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel6, wx.ID_ANY, u"Server Details" ), wx.HORIZONTAL )

		self.text_serverIP = wx.StaticText( sbSizer5.GetStaticBox(), wx.ID_ANY, u"192.168.30.5:5050", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.text_serverIP.Wrap( -1 )

		sbSizer5.Add( self.text_serverIP, 0, wx.ALL, 5 )

		self.button_socketStatus = wx.Button( sbSizer5.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 10,10 ), 0 )
		self.button_socketStatus.SetMaxSize( wx.Size( 10,10 ) )

		sbSizer5.Add( self.button_socketStatus, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_staticText1.SetFont( wx.Font( 8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Arial" ) )
		...
		gSizer1.Add( self.text_temperature, 0, wx.ALL, 5 )
		...
		gSizer1.Add( self.text_skyTemp, 0, wx.ALL, 5 )
		...
		gSizer1.Add( self.text_windspeed, 0, wx.ALL, 5 )
		...
		gSizer1.Add( self.m_staticText381, 0, wx.ALL, 5 )
		...
		gSizer1.Add( self.m_staticText391, 0, wx.ALL, 5 )
		...
		gSizer1.Add( self.text_dewpoint, 0, wx.ALL, 5 )


		self.m_panel3.SetSizer( gSizer1 )
		self.m_panel3.Layout()
		gSizer1.Fit( self.m_panel3 )
		bSizer2.Add( self.m_panel3, 1, wx.ALL, 5 )
		...
		self.text_skyCondition.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, wx.EmptyString ) )
		...
		self.text_windCondition.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, wx.EmptyString ) )
		...
		self.text_humCondition.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, wx.EmptyString ) )
		...
		self.text_rainCondition.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, wx.EmptyString ) )
		...
		bSizer71.Add( self.m_panel4, 0, wx.ALL|wx.EXPAND, 5 )
		...
		gSizer2.Add( self.text_serialNum, 0, wx.ALL, 5 )
		...
		gSizer2.Add( self.text_firmwareVer, 0, wx.ALL, 5 )


		bSizer71.Add( gSizer2, 0, 0, 5 )
		...
		self.panel_portSelect.SetFont( wx.Font( 8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Arial" ) )

		gSizer4 = wx.GridSizer( 0, 6, 0, 0 )

		self.m_staticText45 = wx.StaticText( self.panel_portSelect, wx.ID_ANY, u"Serial Port", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText45.Wrap( -1 )

		gSizer4.Add( self.m_staticText45, 1, wx.ALL, 5 )

		comboBox_comListChoices = []
		self.comboBox_comList = wx.ComboBox( self.panel_portSelect, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 80,20 ), comboBox_comListChoices, 0 )
		self.comboBox_comList.SetSelection( 0 )
		gSizer4.Add( self.comboBox_comList, 0, wx.ALL, 5 )

		self.button_comConnect = wx.Button( self.panel_portSelect, wx.ID_ANY, u"Connect", wx.DefaultPosition, wx.Size( 55,20 ), 0 )
		gSizer4.Add( self.button_comConnect, 0, wx.ALL, 5 )

		self.button_portscan = wx.Button( self.panel_portSelect, wx.ID_ANY, u"Port Scan", wx.DefaultPosition, wx.Size( 60,20 ), 0 )
		gSizer4.Add( self.button_portscan, 0, wx.ALL, 5 )

		self.button_StartSocket = wx.Button( self.panel_portSelect, wx.ID_ANY, u"Start Server", wx.DefaultPosition, wx.Size( 65,20 ), 0 )
		gSizer4.Add( self.button_StartSocket, 0, wx.ALL, 5 )

		self.button_exit = wx.Button( self.panel_portSelect, wx.ID_ANY, u"Exit", wx.DefaultPosition, wx.Size( 35,20 ), 0 )
		gSizer4.Add( self.button_exit, 0, wx.ALL, 5 )


		self.panel_portSelect.SetSizer( gSizer4 )
		self.panel_portSelect.Layout()
		gSizer4.Fit( self.panel_portSelect )
		bSizer8.Add( self.panel_portSelect, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.button_portscan.Bind( wx.EVT_BUTTON, self.button_portscan_OnClick )
		self.button_StartSocket.Bind( wx.EVT_BUTTON, self.button_StartSocket_OnClick )
